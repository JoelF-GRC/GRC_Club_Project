...
| 4 | Chain of custody: the Week 3 gate's evidence is bundled, hashed, and signed keyless with Cosign using the pipeline's own OIDC identity, then checked by a verify script that confirms integrity, authenticity, and (optionally) retention before anyone trusts it | AU-9, SI-7 | A.5.28 (Collection of evidence), A.8.24 (Use of cryptography) | [week-4](week-4/) |
